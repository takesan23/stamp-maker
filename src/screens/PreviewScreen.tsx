    ...
    <SafeAreaView className="flex-1 bg-white">
        ...
        <View className="gap-6">
          ...
          <View className="flex-row items-start gap-2 max-w-[85%]">
            ...
            <View className="gap-1">
              ...
              <View className="bg-white rounded-2xl rounded-tl-none px-4 py-2 shadow-sm">
          ...
          <View className="self-end max-w-[85%]">
            <View className="items-end gap-1">
              <View className="bg-primary rounded-2xl rounded-tr-none px-4 py-2 shadow-sm">
                <Text className="text-sm text-text-main">
                  すごく可愛いです！このまま書き出します。
                </Text>
              </View>
      ...
      <View className="bg-white px-6 pt-4 pb-8 border-t border-gray-100">
        <View className="gap-3">
          <TouchableOpacity className="flex-row items-center justify-center h-14 bg-primary rounded-full shadow-lg">
            <MaterialIcons
              name="download-for-offline"
              size={22}
              color="#121715"
            />
            <Text className="text-base font-bold text-text-main ml-2">
              書き出す (ZIP)
            </Text>
          </TouchableOpacity>
